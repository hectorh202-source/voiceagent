...
export async function handleLeadIntake(req: Request, res: Response): Promise<void> {
  ...
  // The "email me new leads" alert (if this business has it on) fires
  // centrally from insertInboundLead itself — nothing to do here, for
  // website_chat or website_form.
